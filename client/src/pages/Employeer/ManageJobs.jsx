  ...
  const handleStatusChange = async (jobId) => {
    try {
      ...
      if (response.data.isClosed === true) {
        toast.success("Job is Closed");
      } else {
        toast.success("Job is Active");
      }
  ...
  const getPostedJobs = async (disableLoader) => {
    ...
    try {
      const response = await axiosInstance.get(
        API_PATHS.JOBS.GET_JOBS_EMPLOYEER
      );
          ...
          <div className="mb-8">
            <div className="flex flex-row items-center justify-between">
              ...
              <button
                ...
                onClick={() => navigate("/employeer/post-jobs")}
              >
                ...
                <div className="w-[75vw] md:w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 ">
                  <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gradient-to-r from-gray-50 to-gray-100/50">
                      <tr>
                        <th
                          className="px-6 py-4 text-left text-sx font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0 "
                        ...
                        <th className="px-6 py-4 text-left text-sx font-semibold text-gray-600 uppercase tracking-wider cursor-pointer hover:bg-gray-100/60 transition-all duration-200 min-w-[200px] sm:min-w-0">
                          Actions
                        </th>
                      </tr>
                    </thead>
                        ...
                        : paginatedJobs.map((job) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-5 whitespace-nowrap min-w-[180px] sm:min-w-0 ">
                                <div className="flex space-x-2">
                                  <button
                                    className=" text-blue-600 hover:text-blue-800 font-semibold transition-colors duration-200 hover:bg-blue-50 p-2 py-1 rounded-lg "
                                    onClick={() =>
                                      navigate("/employeer/post-jobs", {
                                        state: { jobId: job.id },
                                      })
                                    }
                                  >
                                  ...
                                  {job.status === "Active" ? (
                                    <button
                                      className="flex items-center gap-2 text-xs text-orange-600 hover:text-orange-800 p-2 rounded-lg transition-colors duration-200 hover:bg-orange-50"
                                    ...
                                    <button
                                      className="flex items-center gap-2 text-xs text-green-600 hover:text-green-800 p-2 rounded-lg transition-colors duration-200 hover:bg-green-50"
                                      onClick={() => handleStatusChange(job.id)}
                                    >
              ...
              <div className="mt-6 flex items-center justify-between">
                <div className="flex-1 flex justify-between sm:hidden">
                  <button
                    ...
                    className="relative inline-flex items-center px-4 py-2 border text-sm font-medium  bg-white border-gray-300 text-gray-700 hover:bg-gray-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Previous
                  </button>
                  <button
                    ...
                    className="ml-3 relative inline-flex items-center px-4 py-2 border text-sm font-medium  bg-white border-gray-300 text-gray-700 hover:bg-gray-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed "
                  >
                    Next
                  </button>
                </div>
                <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                  <div>
                    <p className="text-wm text-gray-700">
                      Showing{" "}
                  ...
                  <div>
                    <nav className="relative inline-flex z-0 rounded-md shadow-sm -space-x-px">
                      {/*   */}
                      <button
                        onClick={() =>
                        ...
                        disabled={currentPage === 1}
                        className="relative inline-flex items-center px-2 py-2 rounded-l-md border text-sm font-medium  bg-white border-gray-300 text-gray-500 hover:bg-gray-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Previous
                      </button>
                      ...
                      <button
                        ...
                        className="relative inline-flex items-center px-2 py-2 rounded-r-md border text-sm font-medium  bg-white border-gray-300 text-gray-500 hover:bg-gray-50 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
                      >
                        Next
                      </button>
                    </nav>

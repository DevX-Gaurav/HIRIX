...
const ApplicationViewer = () => {
  ...
  useEffect(() => {
    ...
    else navigate("/employeer/manage-jobs");
  }, []);
  ...
  return (
    <DashboardLayout activeMenu="applicants">
      ...
      <div className="min-h-[60px] bg-gray-50">
        {/* header */}
        <div className="mb-8">
                          ...
                          >
                            <div className="flex items-center gap-4">
                              ...
                              <div className="min-w-0 flex-1">
                                ...
                                <div className="flex items-center gap-1 mt-1 text-gray-500txt-xs  ">
                            ...
                            <div className="flex items-center gap-3 mt-4 md:m-0">
                              ...
                              <button
                                className="inline-flex items-center gap-2 px-3 py-2 bg-blue-100 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-200 transition-colors"
                                onClick={() =>

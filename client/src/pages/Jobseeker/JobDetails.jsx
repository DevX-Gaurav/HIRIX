...
const JobDetails = () => {
  ...
  const applyToJob = async () => {
    try {
      ...
      const errorMsg = error?.respone?.data?.message;
      toast.error(
        "Only Job Seekers can apply" ||
          errorMsg ||
          "Something went wrong while applying to job! Try again later."
      );
    }
  };
        ...
        {jobDetails && (
          <div className="bg-white p-6 rounded-lg">
              ...
              <div className="relative z-10 ">
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div className="flex-1">
                    <h1 className="text-lg lg:text-lg font-semibold mb-2 leading-tight text-gray-900 ">
                      {" "}
                      {jobDetails.title}
                    </h1>
            ...
            <div className="px-0 pb-8 space-y-8">
              ...
              {/* requirements */}
              <div className="space-y-4">
                <h3 className="text-2xl font-semibold text-gray-900 flex items-center space-x-4">

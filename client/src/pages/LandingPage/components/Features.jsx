        ...
        <div className="grid md:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-blue-500 to to-blue-600 mx-auto rounded-full" />
            </div>
          ...
          <div>
            <div className="text-center mb-12">
              ...
              <div className="w-24 h-1 bg-gradient-to-r from-purple-500 to bg-purple-600 rounded-full mx-auto" />
            </div>

...
const statusOptions = ["Applied", "Review", "Rejected", "Accepted"];
...
const ApplicantProfilePreview = ({
  ...
  return (
    <section className="fixed inset-0 bg-[rgba(0,0,0,0.2)]   flex items-center justify-center p-4  z-50 ">
      <div className="bg-white rounded-xl  shadow-xl max-w-lg w-full min-h-screen overflow-y-auto">
        {/* Modal header */}
          ...
          <div className="text-center mb-6">
            {selectedApplicant.applicant.avatar ? (
              <img
                ...
                alt={selectedApplicant.applicant.avatar}
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-gray-900">
                    {moment(selectedApplicant.applicant.createdAt)?.format(
                      "DD-MM-YYYY"
                    )}
                  </span>
                </div>

...
export const jobSeekerFeatures = [
  ...
  },
  {
    ...
    description:
      " Create professional resumes with our intutive builder and templates designed by experts.",
  },
  {
    icon: MessageSquare,
    title: "Direct Communication",
    description:
      " Connect directly with hiring managers and recruiters through our secure messaging platforms.",
  },
  {
    icon: Award,
...
export const employerFeatures = [
  ...
  },
  {
    ...
    description:
      "Track your hiring performance with detailed analytics and insighs on candidate engagement.",
  },
  {
    icon: Shield,
...
export const NAVIGATION_MENU = [
  { id: "employeer-dashboard", name: "Dashboard", icon: LayoutDashboard },
  { id: "post-jobs", name: "Post Jobs", icon: Plus },
